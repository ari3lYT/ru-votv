...
Перевод для ветки `0.9.0`, собран и проверен на локальной сборке `a09k`.
...
- Voices of the Void `0.9.0 / a09k`
- Windows
- Linux через Proton 9.0

На других сборках `0.9.0` перевод может работать, если игра подхватывает `_P.pak`
из папки `VotV/Content/Paks`.
